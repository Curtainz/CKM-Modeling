...
# 读取数据
data <- read_dta("D:/GitHub/CKM-Modeling/ProcessedData/CHARLS-2015/Completed/1-combined_data.dta")

# 将<zda007_1_, zda008_1_, zda007_3_, zda007_7_, zda007_8_, zda007_9_>中的非空值覆盖到<da007_1_, da008_1_, da007_3_, da007_7_, da007_8_, da007_9_>
data <- data %>%
  mutate(
    da007_1_ = coalesce(zda007_1_, da007_1_),
    da008_1_ = coalesce(zda008_1_, da008_1_),
    da007_3_ = coalesce(zda007_3_, da007_3_),
    da007_7_ = coalesce(zda007_7_, da007_7_),
    da007_8_ = coalesce(zda007_8_, da007_8_),
    da007_9_ = coalesce(zda007_9_, da007_9_)
  )
...
# 保存数据
write_dta(data, "D:/GitHub/CKM-Modeling/ProcessedData/CHARLS-2015/Completed/2-cleaned_data.dta")
