...
extracted_healthdata <- healthdata %>% select(ID, householdID, communityID, da007_1_, da008_1_, da007_3_, da007_7_, da007_8_, da007_9_, da011s1, da011s2,
                                                                            zda007_1_, zda008_1_, zda007_3_, zda007_7_, zda007_8_, zda007_9_)
...
# 导出数据
write_dta(merged_data_2, "D:/GitHub/CKM-Modeling/ProcessedData/CHARLS-2015/Completed/1-combined_data.dta")
